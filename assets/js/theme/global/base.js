            ...
            if (data.loc) {
                ...
                if (data.loc=="US") {
                    setTimeout(function() {
                        ...
                        $(".popup-country-main").append("Are you visiting Superhairpieces.es from U.S.?<br/>Visit our official global site for more relevant pricing, promotions and events.")

                        $(".popup-country-link").append("take me there")
                        $(".popup-country-continue").append("<div>No, soy de España</div><div class=popup-country-continue-link>Continuar navegando!</div>")
